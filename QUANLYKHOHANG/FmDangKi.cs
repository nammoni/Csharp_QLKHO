    ...
    public partial class FmDangKi : Form
    {
        ...
        private void btnMaOTP_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                const string frompass = "hiexrlydznvqqkui";//mã trong gmail để có thể kết nối
                const string subject = "OTP code";
                string body = otp.ToString();
                var smtp = new SmtpClient
                {
                    Host = "smtp.gmail.com",//dạng gmail
                    Port = 587,
                    EnableSsl = true,
                ...
                MessageBox.Show("OTP đã được gửi qua mail","Thông báo");
            }
            catch (Exception ex)
            {
